...
if("${SG200X_SDK_PATH}" STREQUAL "" AND DEFINED ENV{SG200X_SDK_PATH})
    set(SG200X_SDK_PATH $ENV{SG200X_SDK_PATH})
endif()

if("${SG200X_SDK_PATH}" STREQUAL "")
    if(EXISTS "${ROOT_DIR}/sg2002_recamera_emmc")
        set(SG200X_SDK_PATH "${ROOT_DIR}/sg2002_recamera_emmc")
        message(STATUS "Using default SG200X_SDK_PATH: ${SG200X_SDK_PATH}")
    endif()
endif()
...
include(${PROJECT_DIR}/src/CMakeLists.txt)
